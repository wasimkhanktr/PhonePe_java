		...
		while(flag)
		{
			try {
				...
				if(lock >0)
				{
					...
					{
						System.out.println("your SBI bank Account balance is RS."+balance);
						flag=false;
					...
					if(lock==0)
					{
						...
						System.err.println("Your SBI UPI is locked for 24 hours");
						flag=false;
					}
				}
				else
