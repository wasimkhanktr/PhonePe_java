...
class ICICI implements Bank
{
	...
	public void upiPin()
	{
			if(ICICI.getUpiPin().equals("null"))
			{
				Scanner scan=new Scanner(System.in);
				boolean flag=true;
		        while(flag)
		...
		while(flag)
		{
			try {
				...
				if(lock >0)
				{
					...
					{
						System.out.println("your ICICI bank Account balance is RS."+balance);
						flag=false;
					...
					if(lock==0)
					{
						...
						System.err.println("Your ICICI UPI is locked for 24 hours");
						flag=false;
					}
				}
				else
